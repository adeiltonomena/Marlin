...
#define CUSTOM_MACHINE_NAME "3DP CH"
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  //
  #define DEFAULT_chamberKp 20.71
  #define DEFAULT_chamberKi 0.49
  #define DEFAULT_chamberKd 585.8
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 40, 1280.32, 508 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 15, 25, 0 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  90, 217, (Z_MIN_POS + 2) } }
  #define NOZZLE_CLEAN_END_POINT   { { 5, 2010, (Z_MIN_POS + 2) } }
